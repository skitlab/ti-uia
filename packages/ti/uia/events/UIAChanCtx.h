...
#define ti_uia_events_UIAChanCtx___VERS 150
...
xdc__CODESECT(ti_uia_events_UIAChanCtx_Module__startupDone__S, "ti_uia_events_UIAChanCtx_Module__startupDone")
...
xdc__CODESECT(ti_uia_events_UIAChanCtx_isLoggingEnabled__F, "ti_uia_events_UIAChanCtx_isLoggingEnabled")
__extern xdc_Bool ti_uia_events_UIAChanCtx_isLoggingEnabled__F( xdc_UInt newChanId );
__extern xdc_Bool ti_uia_events_UIAChanCtx_isLoggingEnabled__R( xdc_UInt newChanId );
...
xdc__CODESECT(ti_uia_events_UIAChanCtx_setOldValue__F, "ti_uia_events_UIAChanCtx_setOldValue")
__extern xdc_UInt ti_uia_events_UIAChanCtx_setOldValue__F( xdc_UInt newValue );
__extern xdc_UInt ti_uia_events_UIAChanCtx_setOldValue__R( xdc_UInt newValue );
