...
#define ti_uia_events_UIAProfile___VERS 150
...
/* enterFunction */
#define ti_uia_events_UIAProfile_enterFunction (ti_uia_events_UIAProfile_enterFunction__C)
typedef xdc_runtime_Log_Event CT__ti_uia_events_UIAProfile_enterFunction;
__extern __FAR__ const CT__ti_uia_events_UIAProfile_enterFunction ti_uia_events_UIAProfile_enterFunction__C;

/* exitFunction */
#define ti_uia_events_UIAProfile_exitFunction (ti_uia_events_UIAProfile_exitFunction__C)
typedef xdc_runtime_Log_Event CT__ti_uia_events_UIAProfile_exitFunction;
__extern __FAR__ const CT__ti_uia_events_UIAProfile_exitFunction ti_uia_events_UIAProfile_exitFunction__C;
...
xdc__CODESECT(ti_uia_events_UIAProfile_Module__startupDone__S, "ti_uia_events_UIAProfile_Module__startupDone")
...
/* module prefix */
#define UIAProfile_enterFunction ti_uia_events_UIAProfile_enterFunction
#define UIAProfile_exitFunction ti_uia_events_UIAProfile_exitFunction
