...
#define ti_uia_events_UIARoundtrip___VERS 150
...
xdc__CODESECT(ti_uia_events_UIARoundtrip_Module__startupDone__S, "ti_uia_events_UIARoundtrip_Module__startupDone")
