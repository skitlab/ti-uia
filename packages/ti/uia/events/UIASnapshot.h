...
#define ti_uia_events_UIASnapshot___VERS 150
...
xdc__CODESECT(ti_uia_events_UIASnapshot_Module__startupDone__S, "ti_uia_events_UIASnapshot_Module__startupDone")
