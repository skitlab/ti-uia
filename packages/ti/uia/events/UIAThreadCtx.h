...
#define ti_uia_events_UIAThreadCtx___VERS 150
...
xdc__CODESECT(ti_uia_events_UIAThreadCtx_Module__startupDone__S, "ti_uia_events_UIAThreadCtx_Module__startupDone")
...
xdc__CODESECT(ti_uia_events_UIAThreadCtx_isLoggingEnabled__F, "ti_uia_events_UIAThreadCtx_isLoggingEnabled")
__extern xdc_Bool ti_uia_events_UIAThreadCtx_isLoggingEnabled__F( xdc_UInt newThreadId );
__extern xdc_Bool ti_uia_events_UIAThreadCtx_isLoggingEnabled__R( xdc_UInt newThreadId );
...
xdc__CODESECT(ti_uia_events_UIAThreadCtx_setOldValue__F, "ti_uia_events_UIAThreadCtx_setOldValue")
__extern xdc_UInt ti_uia_events_UIAThreadCtx_setOldValue__F( xdc_UInt newValue );
__extern xdc_UInt ti_uia_events_UIAThreadCtx_setOldValue__R( xdc_UInt newValue );
