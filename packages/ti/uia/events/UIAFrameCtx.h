...
#define ti_uia_events_UIAFrameCtx___VERS 150
...
xdc__CODESECT(ti_uia_events_UIAFrameCtx_Module__startupDone__S, "ti_uia_events_UIAFrameCtx_Module__startupDone")
...
xdc__CODESECT(ti_uia_events_UIAFrameCtx_isLoggingEnabled__F, "ti_uia_events_UIAFrameCtx_isLoggingEnabled")
__extern xdc_Bool ti_uia_events_UIAFrameCtx_isLoggingEnabled__F( xdc_UInt newFrameId );
__extern xdc_Bool ti_uia_events_UIAFrameCtx_isLoggingEnabled__R( xdc_UInt newFrameId );
...
xdc__CODESECT(ti_uia_events_UIAFrameCtx_setOldValue__F, "ti_uia_events_UIAFrameCtx_setOldValue")
__extern xdc_UInt ti_uia_events_UIAFrameCtx_setOldValue__F( xdc_UInt newValue );
__extern xdc_UInt ti_uia_events_UIAFrameCtx_setOldValue__R( xdc_UInt newValue );
