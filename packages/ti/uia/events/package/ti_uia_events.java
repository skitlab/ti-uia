...
public class ti_uia_events
{
    ...
    void UIAProfile$$TYPES()
    {
        ...
        po.init("ti.uia.events.UIAProfile.Module", om.findStrict("ti.uia.events.IUIAEvent.Module", "ti.uia.events"));
                po.addFld("$hostonly", $$T_Num, 0, "r");
        if (isCFG) {
            po.addFld("enterFunction", (Proto)om.findStrict("xdc.runtime.Log$$Event", "ti.uia.events"), Global.newObject("mask", 0x0001L, "msg", "enterFunction: taskHandle=0x%x, adrs=0x%x"), "w");
            po.addFld("metaEventEnterFunction", (Proto)om.findStrict("ti.uia.events.DvtTypes.MetaEventDescriptor", "ti.uia.events"), Global.newObject("versionId", "2.0", "analysisType", om.find("ti.uia.events.DvtTypes.DvtAnalysisType_START"), "displayText", "enterFunction", "tooltipText", "function entry", "numParameters", 2L, "paramInfo", Global.newArray(new Object[]{Global.newObject("name", "Qualifier", "dataDesc", om.find("ti.uia.events.DvtTypes.DvtDataDesc_INSTANCE"), "dataTypeName", "Int", "units", "none", "isHidden", false), Global.newObject("name", "FunctionAdrs", "dataDesc", om.find("ti.uia.events.DvtTypes.DvtDataDesc_FUNCTIONADRS"), "dataTypeName", "Int", "units", "none", "isHidden", false)})), "wh");
            po.addFld("exitFunction", (Proto)om.findStrict("xdc.runtime.Log$$Event", "ti.uia.events"), Global.newObject("mask", 0x0002L, "msg", "exitFunction: taskHandle=0x%x, adrs=0x%x"), "w");
            po.addFld("metaEventExitFunction", (Proto)om.findStrict("ti.uia.events.DvtTypes.MetaEventDescriptor", "ti.uia.events"), Global.newObject("versionId", "2.0", "analysisType", om.find("ti.uia.events.DvtTypes.DvtAnalysisType_STOP"), "displayText", "exitFunction", "tooltipText", "Marks the end of analysis for a module instance", "numParameters", 2L, "paramInfo", Global.newArray(new Object[]{Global.newObject("name", "Qualifier", "dataDesc", om.find("ti.uia.events.DvtTypes.DvtDataDesc_INSTANCE"), "dataTypeName", "Int", "units", "none", "isHidden", false), Global.newObject("name", "FunctionAdrs", "dataDesc", om.find("ti.uia.events.DvtTypes.DvtDataDesc_FUNCTIONADRS"), "dataTypeName", "Int", "units", "none", "isHidden", false)})), "wh");
        }//isCFG
    }
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/release/ti.uia.events.a64P',\n");
            sb.append("'lib/release/ti.uia.events.a64Pe',\n");
            sb.append("'lib/release/ti.uia.events.a674',\n");
            sb.append("'lib/release/ti.uia.events.ae64P',\n");
            sb.append("'lib/release/ti.uia.events.ae66',\n");
            sb.append("'lib/release/ti.uia.events.ae66e',\n");
            sb.append("'lib/release/ti.uia.events.ae64Pe',\n");
            sb.append("'lib/release/ti.uia.events.ae674',\n");
            sb.append("'lib/release/ti.uia.events.ae64T',\n");
            sb.append("'lib/release/ti.uia.events.ae9',\n");
            sb.append("'lib/release/ti.uia.events.aem3',\n");
            sb.append("'lib/release/ti.uia.events.aem4f',\n");
            sb.append("'lib/release/ti.uia.events.aea8f',\n");
            sb.append("'lib/release/ti.uia.events.aea8fnv',\n");
            sb.append("'lib/release/ti.uia.events.ae430X',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/release/ti.uia.events.a28FP', {target: 'ti.targets.C28_float', suffix: '28FP'}],\n");
            sb.append("['lib/release/ti.uia.events.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/release/ti.uia.events.a64Pe', {target: 'ti.targets.C64P_big_endian', suffix: '64Pe'}],\n");
            sb.append("['lib/release/ti.uia.events.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/release/ti.uia.events.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/release/ti.uia.events.ae66', {target: 'ti.targets.elf.C66', suffix: 'e66'}],\n");
            sb.append("['lib/release/ti.uia.events.ae66e', {target: 'ti.targets.elf.C66_big_endian', suffix: 'e66e'}],\n");
            sb.append("['lib/release/ti.uia.events.ae64Pe', {target: 'ti.targets.elf.C64P_big_endian', suffix: 'e64Pe'}],\n");
            sb.append("['lib/release/ti.uia.events.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/release/ti.uia.events.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
            ...
            sb.append("['lib/release/ti.uia.events.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
            sb.append("['lib/release/ti.uia.events.aea8fnv', {target: 'ti.targets.arm.elf.A8Fnv', suffix: 'ea8fnv'}],\n");
            sb.append("['lib/release/ti.uia.events.ae430X', {target: 'ti.targets.msp430.elf.MSP430X', suffix: 'e430X'}],\n");
        sb.append("];\n");
    ...
    void UIAAppCtx$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_uia_events_UIAAppCtx_Module__startupDone__E", "ti_uia_events_UIAAppCtx_getCtxId__E", "ti_uia_events_UIAAppCtx_isLoggingEnabled__E", "ti_uia_events_UIAAppCtx_setOldValue__E"));
    ...
    void UIAChanCtx$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_uia_events_UIAChanCtx_Module__startupDone__E", "ti_uia_events_UIAChanCtx_getCtxId__E", "ti_uia_events_UIAChanCtx_isLoggingEnabled__E", "ti_uia_events_UIAChanCtx_setOldValue__E"));
        vo.bind("$$logEvtCfgs", Global.newArray("ctxChg"));
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
    ...
    void UIAFrameCtx$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_uia_events_UIAFrameCtx_Module__startupDone__E", "ti_uia_events_UIAFrameCtx_getCtxId__E", "ti_uia_events_UIAFrameCtx_isLoggingEnabled__E", "ti_uia_events_UIAFrameCtx_setOldValue__E"));
        vo.bind("$$logEvtCfgs", Global.newArray("ctxChg"));
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
    ...
    void UIAProfile$$SINGLETONS()
    {
        ...
        mcfgs.add("Object__table");
        icfgs.add("Object__table");
        mcfgs.add("enterFunction");
        mcfgs.add("exitFunction");
        vo.bind("$$tdefs", Global.newArray(tdefs.toArray()));
        vo.bind("$$proxies", Global.newArray(proxies.toArray()));
        vo.bind("$$mcfgs", Global.newArray(mcfgs.toArray()));
        vo.bind("$$icfgs", Global.newArray(icfgs.toArray()));
        ...
        vo.bind("$$logEvtCfgs", Global.newArray("enterFunction", "exitFunction"));
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
        atmap.seal("length");
    ...
    void UIAThreadCtx$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_uia_events_UIAThreadCtx_Module__startupDone__E", "ti_uia_events_UIAThreadCtx_getCtxId__E", "ti_uia_events_UIAThreadCtx_isLoggingEnabled__E", "ti_uia_events_UIAThreadCtx_setOldValue__E"));
    ...
    void UIAUserCtx$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_uia_events_UIAUserCtx_Module__startupDone__E", "ti_uia_events_UIAUserCtx_getCtxId__E", "ti_uia_events_UIAUserCtx_isLoggingEnabled__E", "ti_uia_events_UIAUserCtx_setOldValue__E"));
        vo.bind("$$logEvtCfgs", Global.newArray("ctxChg"));
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
