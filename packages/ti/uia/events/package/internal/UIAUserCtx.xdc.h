...
#define ti_uia_events_UIAUserCtx_Module_startup ti_uia_events_UIAUserCtx_Module_startup__F

/* Instance_init */
#undef ti_uia_events_UIAUserCtx_Instance_init
#define ti_uia_events_UIAUserCtx_Instance_init ti_uia_events_UIAUserCtx_Instance_init__F

/* Instance_finalize */
#undef ti_uia_events_UIAUserCtx_Instance_finalize
#define ti_uia_events_UIAUserCtx_Instance_finalize ti_uia_events_UIAUserCtx_Instance_finalize__F
