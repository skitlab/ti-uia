...
#define ti_uia_events_UIAUserCtx___VERS 150
...
xdc__CODESECT(ti_uia_events_UIAUserCtx_Module__startupDone__S, "ti_uia_events_UIAUserCtx_Module__startupDone")
...
xdc__CODESECT(ti_uia_events_UIAUserCtx_isLoggingEnabled__F, "ti_uia_events_UIAUserCtx_isLoggingEnabled")
__extern xdc_Bool ti_uia_events_UIAUserCtx_isLoggingEnabled__F( xdc_UInt newUserCtx );
__extern xdc_Bool ti_uia_events_UIAUserCtx_isLoggingEnabled__R( xdc_UInt newUserCtx );
...
xdc__CODESECT(ti_uia_events_UIAUserCtx_setOldValue__F, "ti_uia_events_UIAUserCtx_setOldValue")
__extern xdc_UInt ti_uia_events_UIAUserCtx_setOldValue__F( xdc_UInt newValue );
__extern xdc_UInt ti_uia_events_UIAUserCtx_setOldValue__R( xdc_UInt newValue );
