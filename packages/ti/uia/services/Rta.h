...
#define ti_uia_services_Rta___VERS 150
...
xdc__CODESECT(ti_uia_services_Rta_Module__startupDone__S, "ti_uia_services_Rta_Module__startupDone")
...
__extern xdc_Void ti_uia_services_Rta_processCallback__R( ti_uia_runtime_ServiceMgr_Reason reason, ti_uia_runtime_UIAPacket_Hdr* cmd );
...
__extern xdc_Void ti_uia_services_Rta_disableAllLogs__R( void );
...
__extern xdc_Void ti_uia_services_Rta_enableAllLogs__R( void );
...
__extern xdc_Void ti_uia_services_Rta_snapshotAllLogs__R( xdc_UArg reset, xdc_UArg waitPeriod );
...
__extern xdc_Void ti_uia_services_Rta_resetAllLogs__R( void );
...
__extern xdc_Void ti_uia_services_Rta_startDataTx__R( void );
...
__extern xdc_Void ti_uia_services_Rta_stopDataTx__R( void );
...
#endif
/*
 *  @(#) ti.uia.services; 1, 0, 0, 0,1; 7-13-2012 11:12:27; /db/vtree/library/trees/uia/uia-d14/src/ xlibrary
