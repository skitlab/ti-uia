...
#define ti_uia_family_c64p_TimestampC64XLocal___VERS 150
...
xdc__CODESECT(ti_uia_family_c64p_TimestampC64XLocal_Module_startup__R, "ti_uia_family_c64p_TimestampC64XLocal_Module_startup")
__extern xdc_Int ti_uia_family_c64p_TimestampC64XLocal_Module_startup__R( xdc_Int state );

/* Instance_init__F */
xdc__CODESECT(ti_uia_family_c64p_TimestampC64XLocal_Instance_init__F, "ti_uia_family_c64p_TimestampC64XLocal_Instance_init")
__extern void ti_uia_family_c64p_TimestampC64XLocal_Instance_init__F( ti_uia_family_c64p_TimestampC64XLocal_Object*, const ti_uia_family_c64p_TimestampC64XLocal_Params* );

/* Instance_init__R */
xdc__CODESECT(ti_uia_family_c64p_TimestampC64XLocal_Instance_init__R, "ti_uia_family_c64p_TimestampC64XLocal_Instance_init")
__extern void ti_uia_family_c64p_TimestampC64XLocal_Instance_init__R( ti_uia_family_c64p_TimestampC64XLocal_Object*, const ti_uia_family_c64p_TimestampC64XLocal_Params* );

/* Handle__label__S */
xdc__CODESECT(ti_uia_family_c64p_TimestampC64XLocal_Handle__label__S, "ti_uia_family_c64p_TimestampC64XLocal_Handle__label")
...
xdc__CODESECT(ti_uia_family_c64p_TimestampC64XLocal_Module__startupDone__S, "ti_uia_family_c64p_TimestampC64XLocal_Module__startupDone")
__extern xdc_Bool ti_uia_family_c64p_TimestampC64XLocal_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_uia_family_c64p_TimestampC64XLocal_Object__create__S, "ti_uia_family_c64p_TimestampC64XLocal_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_uia_family_c64p_TimestampC64XLocal_Object__delete__S, "ti_uia_family_c64p_TimestampC64XLocal_Object__delete")
__extern xdc_Void ti_uia_family_c64p_TimestampC64XLocal_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_uia_family_c64p_TimestampC64XLocal_Object__destruct__S, "ti_uia_family_c64p_TimestampC64XLocal_Object__destruct")
__extern xdc_Void ti_uia_family_c64p_TimestampC64XLocal_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_uia_family_c64p_TimestampC64XLocal_Object__get__S, "ti_uia_family_c64p_TimestampC64XLocal_Object__get")
__extern xdc_Ptr ti_uia_family_c64p_TimestampC64XLocal_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_uia_family_c64p_TimestampC64XLocal_Object__first__S, "ti_uia_family_c64p_TimestampC64XLocal_Object__first")
__extern xdc_Ptr ti_uia_family_c64p_TimestampC64XLocal_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_uia_family_c64p_TimestampC64XLocal_Object__next__S, "ti_uia_family_c64p_TimestampC64XLocal_Object__next")
__extern xdc_Ptr ti_uia_family_c64p_TimestampC64XLocal_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_uia_family_c64p_TimestampC64XLocal_Params__init__S, "ti_uia_family_c64p_TimestampC64XLocal_Params__init")
__extern xdc_Void ti_uia_family_c64p_TimestampC64XLocal_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(ti_uia_family_c64p_TimestampC64XLocal_get32__F, "ti_uia_family_c64p_TimestampC64XLocal_get32")
__extern xdc_Bits32 ti_uia_family_c64p_TimestampC64XLocal_get32__F( void );
__extern xdc_Bits32 ti_uia_family_c64p_TimestampC64XLocal_get32__R( void );
...
xdc__CODESECT(ti_uia_family_c64p_TimestampC64XLocal_get64__F, "ti_uia_family_c64p_TimestampC64XLocal_get64")
__extern xdc_Void ti_uia_family_c64p_TimestampC64XLocal_get64__F( xdc_runtime_Types_Timestamp64* result );
__extern xdc_Void ti_uia_family_c64p_TimestampC64XLocal_get64__R( xdc_runtime_Types_Timestamp64* result );
...
xdc__CODESECT(ti_uia_family_c64p_TimestampC64XLocal_getFreq__F, "ti_uia_family_c64p_TimestampC64XLocal_getFreq")
__extern xdc_Void ti_uia_family_c64p_TimestampC64XLocal_getFreq__F( xdc_runtime_Types_FreqHz* freq );
__extern xdc_Void ti_uia_family_c64p_TimestampC64XLocal_getFreq__R( xdc_runtime_Types_FreqHz* freq );
...
xdc__CODESECT(ti_uia_family_c64p_TimestampC64XLocal_setFreq__F, "ti_uia_family_c64p_TimestampC64XLocal_setFreq")
__extern xdc_Void ti_uia_family_c64p_TimestampC64XLocal_setFreq__F( xdc_runtime_Types_FreqHz* freq );
__extern xdc_Void ti_uia_family_c64p_TimestampC64XLocal_setFreq__R( xdc_runtime_Types_FreqHz* freq );
...
{
    if (dst) {
        ti_uia_family_c64p_TimestampC64XLocal_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_uia_family_c64p_TimestampC64XLocal_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* create */
static inline ti_uia_family_c64p_TimestampC64XLocal_Handle ti_uia_family_c64p_TimestampC64XLocal_create( const ti_uia_family_c64p_TimestampC64XLocal_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (ti_uia_family_c64p_TimestampC64XLocal_Handle)ti_uia_family_c64p_TimestampC64XLocal_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(ti_uia_family_c64p_TimestampC64XLocal_Params), __eb);
}

/* construct */
static inline void ti_uia_family_c64p_TimestampC64XLocal_construct( ti_uia_family_c64p_TimestampC64XLocal_Struct* __obj, const ti_uia_family_c64p_TimestampC64XLocal_Params* __prms )
{
    ti_uia_family_c64p_TimestampC64XLocal_Object__create__S(__obj, sizeof (ti_uia_family_c64p_TimestampC64XLocal_Struct), 0, (const xdc_UChar*)__prms, sizeof(ti_uia_family_c64p_TimestampC64XLocal_Params), NULL);
}

/* delete */
static inline void ti_uia_family_c64p_TimestampC64XLocal_delete( ti_uia_family_c64p_TimestampC64XLocal_Handle* instp )
{
    ti_uia_family_c64p_TimestampC64XLocal_Object__delete__S(instp);
}

/* destruct */
static inline void ti_uia_family_c64p_TimestampC64XLocal_destruct( ti_uia_family_c64p_TimestampC64XLocal_Struct* obj )
{
    ti_uia_family_c64p_TimestampC64XLocal_Object__destruct__S(obj);
}
...
#endif
/*
 *  @(#) ti.uia.family.c64p; 1, 0, 0, 0,1; 7-13-2012 11:12:08; /db/vtree/library/trees/uia/uia-d14/src/ xlibrary
