...
#define ti_uia_family_c64p_GemTraceSync_Module_GateProxy___VERS 150
...
/* Handle__label__S */
xdc__CODESECT(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Handle__label__S, "ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Handle__label")
...
xdc__CODESECT(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Module__startupDone__S, "ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Module__startupDone")
__extern xdc_Bool ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__create__S, "ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__delete__S, "ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__delete")
__extern xdc_Void ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__destruct__S, "ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__destruct")
__extern xdc_Void ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__get__S, "ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__get")
__extern xdc_Ptr ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__first__S, "ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__first")
__extern xdc_Ptr ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__next__S, "ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__next")
__extern xdc_Ptr ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Params__init__S, "ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Params__init")
__extern xdc_Void ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Proxy__abstract__S, "ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Proxy__abstract")
__extern xdc_Bool ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Proxy__delegate__S, "ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Proxy__delegate")
...
xdc__CODESECT(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_query__R, "ti_uia_family_c64p_GemTraceSync_Module_GateProxy_query")
__extern xdc_Bool ti_uia_family_c64p_GemTraceSync_Module_GateProxy_query__R( xdc_Int qual );
...
xdc__CODESECT(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_enter__R, "ti_uia_family_c64p_GemTraceSync_Module_GateProxy_enter")
__extern xdc_IArg ti_uia_family_c64p_GemTraceSync_Module_GateProxy_enter__R( ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Handle __inst );
...
xdc__CODESECT(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_leave__R, "ti_uia_family_c64p_GemTraceSync_Module_GateProxy_leave")
__extern xdc_Void ti_uia_family_c64p_GemTraceSync_Module_GateProxy_leave__R( ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Handle __inst, xdc_IArg key );
...
/* enter_{FxnT,fxnP} */
typedef xdc_IArg (*ti_uia_family_c64p_GemTraceSync_Module_GateProxy_enter_FxnT)(void*);
static inline ti_uia_family_c64p_GemTraceSync_Module_GateProxy_enter_FxnT ti_uia_family_c64p_GemTraceSync_Module_GateProxy_enter_fxnP( void )
{
    return (ti_uia_family_c64p_GemTraceSync_Module_GateProxy_enter_FxnT)ti_uia_family_c64p_GemTraceSync_Module_GateProxy_enter; 
}

/* leave_{FxnT,fxnP} */
typedef xdc_Void (*ti_uia_family_c64p_GemTraceSync_Module_GateProxy_leave_FxnT)(void*, xdc_IArg);
static inline ti_uia_family_c64p_GemTraceSync_Module_GateProxy_leave_FxnT ti_uia_family_c64p_GemTraceSync_Module_GateProxy_leave_fxnP( void )
{
    return (ti_uia_family_c64p_GemTraceSync_Module_GateProxy_leave_FxnT)ti_uia_family_c64p_GemTraceSync_Module_GateProxy_leave; 
}
...
{
    if (dst) {
        ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}

/* create */
static inline ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Handle ti_uia_family_c64p_GemTraceSync_Module_GateProxy_create( const ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Handle)ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Params), __eb);
}

/* delete */
static inline void ti_uia_family_c64p_GemTraceSync_Module_GateProxy_delete( ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Handle* instp )
{
    ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Object__delete__S(instp);
}
...
#define GemTraceSync_Module_GateProxy_enter_fxnP ti_uia_family_c64p_GemTraceSync_Module_GateProxy_enter_fxnP
#define GemTraceSync_Module_GateProxy_enter_FxnT ti_uia_family_c64p_GemTraceSync_Module_GateProxy_enter_FxnT
#define GemTraceSync_Module_GateProxy_leave ti_uia_family_c64p_GemTraceSync_Module_GateProxy_leave
#define GemTraceSync_Module_GateProxy_leave_fxnP ti_uia_family_c64p_GemTraceSync_Module_GateProxy_leave_fxnP
#define GemTraceSync_Module_GateProxy_leave_FxnT ti_uia_family_c64p_GemTraceSync_Module_GateProxy_leave_FxnT
