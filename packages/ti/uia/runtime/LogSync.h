...
#define ti_uia_runtime_LogSync___VERS 150
...
xdc__CODESECT(ti_uia_runtime_LogSync_Module_startup__R, "ti_uia_runtime_LogSync_Module_startup")
__extern xdc_Int ti_uia_runtime_LogSync_Module_startup__R( xdc_Int state );

/* Instance_init__F */
xdc__CODESECT(ti_uia_runtime_LogSync_Instance_init__F, "ti_uia_runtime_LogSync_Instance_init")
__extern void ti_uia_runtime_LogSync_Instance_init__F( ti_uia_runtime_LogSync_Object*, const ti_uia_runtime_LogSync_Params* );

/* Instance_init__R */
xdc__CODESECT(ti_uia_runtime_LogSync_Instance_init__R, "ti_uia_runtime_LogSync_Instance_init")
__extern void ti_uia_runtime_LogSync_Instance_init__R( ti_uia_runtime_LogSync_Object*, const ti_uia_runtime_LogSync_Params* );

/* Handle__label__S */
xdc__CODESECT(ti_uia_runtime_LogSync_Handle__label__S, "ti_uia_runtime_LogSync_Handle__label")
__extern xdc_runtime_Types_Label* ti_uia_runtime_LogSync_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(ti_uia_runtime_LogSync_Module__startupDone__S, "ti_uia_runtime_LogSync_Module__startupDone")
__extern xdc_Bool ti_uia_runtime_LogSync_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_uia_runtime_LogSync_Object__create__S, "ti_uia_runtime_LogSync_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_uia_runtime_LogSync_Object__delete__S, "ti_uia_runtime_LogSync_Object__delete")
__extern xdc_Void ti_uia_runtime_LogSync_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_uia_runtime_LogSync_Object__destruct__S, "ti_uia_runtime_LogSync_Object__destruct")
__extern xdc_Void ti_uia_runtime_LogSync_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_uia_runtime_LogSync_Object__get__S, "ti_uia_runtime_LogSync_Object__get")
__extern xdc_Ptr ti_uia_runtime_LogSync_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_uia_runtime_LogSync_Object__first__S, "ti_uia_runtime_LogSync_Object__first")
__extern xdc_Ptr ti_uia_runtime_LogSync_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_uia_runtime_LogSync_Object__next__S, "ti_uia_runtime_LogSync_Object__next")
__extern xdc_Ptr ti_uia_runtime_LogSync_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_uia_runtime_LogSync_Params__init__S, "ti_uia_runtime_LogSync_Params__init")
__extern xdc_Void ti_uia_runtime_LogSync_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(ti_uia_runtime_LogSync_enable__F, "ti_uia_runtime_LogSync_enable")
__extern xdc_Bool ti_uia_runtime_LogSync_enable__F( void );
__extern xdc_Bool ti_uia_runtime_LogSync_enable__R( void );
...
xdc__CODESECT(ti_uia_runtime_LogSync_disable__F, "ti_uia_runtime_LogSync_disable")
__extern xdc_Bool ti_uia_runtime_LogSync_disable__F( void );
__extern xdc_Bool ti_uia_runtime_LogSync_disable__R( void );
...
xdc__CODESECT(ti_uia_runtime_LogSync_idleHook__F, "ti_uia_runtime_LogSync_idleHook")
__extern xdc_Void ti_uia_runtime_LogSync_idleHook__F( void );
__extern xdc_Void ti_uia_runtime_LogSync_idleHook__R( void );
...
xdc__CODESECT(ti_uia_runtime_LogSync_timerHook__F, "ti_uia_runtime_LogSync_timerHook")
__extern xdc_Void ti_uia_runtime_LogSync_timerHook__F( xdc_UArg arg );
__extern xdc_Void ti_uia_runtime_LogSync_timerHook__R( xdc_UArg arg );
...
xdc__CODESECT(ti_uia_runtime_LogSync_putSyncPoint__F, "ti_uia_runtime_LogSync_putSyncPoint")
__extern xdc_Void ti_uia_runtime_LogSync_putSyncPoint__F( void );
__extern xdc_Void ti_uia_runtime_LogSync_putSyncPoint__R( void );
...
xdc__CODESECT(ti_uia_runtime_LogSync_isSyncEventRequired__F, "ti_uia_runtime_LogSync_isSyncEventRequired")
__extern xdc_Bool ti_uia_runtime_LogSync_isSyncEventRequired__F( void );
__extern xdc_Bool ti_uia_runtime_LogSync_isSyncEventRequired__R( void );
...
{
    if (dst) {
        ti_uia_runtime_LogSync_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_uia_runtime_LogSync_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* create */
static inline ti_uia_runtime_LogSync_Handle ti_uia_runtime_LogSync_create( const ti_uia_runtime_LogSync_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (ti_uia_runtime_LogSync_Handle)ti_uia_runtime_LogSync_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(ti_uia_runtime_LogSync_Params), __eb);
}

/* construct */
static inline void ti_uia_runtime_LogSync_construct( ti_uia_runtime_LogSync_Struct* __obj, const ti_uia_runtime_LogSync_Params* __prms )
{
    ti_uia_runtime_LogSync_Object__create__S(__obj, sizeof (ti_uia_runtime_LogSync_Struct), 0, (const xdc_UChar*)__prms, sizeof(ti_uia_runtime_LogSync_Params), NULL);
}

/* delete */
static inline void ti_uia_runtime_LogSync_delete( ti_uia_runtime_LogSync_Handle* instp )
{
    ti_uia_runtime_LogSync_Object__delete__S(instp);
}

/* destruct */
static inline void ti_uia_runtime_LogSync_destruct( ti_uia_runtime_LogSync_Struct* obj )
{
    ti_uia_runtime_LogSync_Object__destruct__S(obj);
}
