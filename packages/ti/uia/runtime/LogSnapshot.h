...
#define ti_uia_runtime_LogSnapshot___VERS 150
...
xdc__CODESECT(ti_uia_runtime_LogSnapshot_Module__startupDone__S, "ti_uia_runtime_LogSnapshot_Module__startupDone")
...
xdc__CODESECT(ti_uia_runtime_LogSnapshot_getSnapshotId__F, "ti_uia_runtime_LogSnapshot_getSnapshotId")
__extern xdc_UInt32 ti_uia_runtime_LogSnapshot_getSnapshotId__F( void );
__extern xdc_UInt32 ti_uia_runtime_LogSnapshot_getSnapshotId__R( void );

/* LogSnapshot_doPrint__E */
#define ti_uia_runtime_LogSnapshot_LogSnapshot_doPrint ti_uia_runtime_LogSnapshot_LogSnapshot_doPrint__E
xdc__CODESECT(ti_uia_runtime_LogSnapshot_LogSnapshot_doPrint__E, "ti_uia_runtime_LogSnapshot_LogSnapshot_doPrint")
__extern xdc_Void ti_uia_runtime_LogSnapshot_LogSnapshot_doPrint__E( ti_uia_runtime_LogSnapshot_EventRec* er );
xdc__CODESECT(ti_uia_runtime_LogSnapshot_LogSnapshot_doPrint__F, "ti_uia_runtime_LogSnapshot_LogSnapshot_doPrint")
__extern xdc_Void ti_uia_runtime_LogSnapshot_LogSnapshot_doPrint__F( ti_uia_runtime_LogSnapshot_EventRec* er );
__extern xdc_Void ti_uia_runtime_LogSnapshot_LogSnapshot_doPrint__R( ti_uia_runtime_LogSnapshot_EventRec* er );
...
#define LogSnapshot_LogSnapshot_doPrint ti_uia_runtime_LogSnapshot_LogSnapshot_doPrint
