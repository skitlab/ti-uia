...
#define ti_uia_runtime_LoggerTypes___VERS 150
...
xdc__CODESECT(ti_uia_runtime_LoggerTypes_Module__startupDone__S, "ti_uia_runtime_LoggerTypes_Module__startupDone")
