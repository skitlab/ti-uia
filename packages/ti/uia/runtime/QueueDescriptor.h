...
#define ti_uia_runtime_QueueDescriptor___VERS 150
...
xdc__CODESECT(ti_uia_runtime_QueueDescriptor_Module__startupDone__S, "ti_uia_runtime_QueueDescriptor_Module__startupDone")
...
xdc__CODESECT(ti_uia_runtime_QueueDescriptor_addToList__F, "ti_uia_runtime_QueueDescriptor_addToList")
__extern xdc_Void ti_uia_runtime_QueueDescriptor_addToList__F( ti_uia_runtime_QueueDescriptor_Header* pHdrToAdd );
__extern xdc_Void ti_uia_runtime_QueueDescriptor_addToList__R( ti_uia_runtime_QueueDescriptor_Header* pHdrToAdd );
...
xdc__CODESECT(ti_uia_runtime_QueueDescriptor_initHeader__F, "ti_uia_runtime_QueueDescriptor_initHeader")
__extern xdc_Void ti_uia_runtime_QueueDescriptor_initHeader__F( ti_uia_runtime_QueueDescriptor_Header* pHdr, xdc_Ptr start, xdc_SizeT size, xdc_UInt loggerModuleId, xdc_UInt loggerInstanceId, xdc_UInt loggerPriority, ti_uia_runtime_QueueDescriptor_QueueType type, xdc_Ptr pNumDroppedCtr );
__extern xdc_Void ti_uia_runtime_QueueDescriptor_initHeader__R( ti_uia_runtime_QueueDescriptor_Header* pHdr, xdc_Ptr start, xdc_SizeT size, xdc_UInt loggerModuleId, xdc_UInt loggerInstanceId, xdc_UInt loggerPriority, ti_uia_runtime_QueueDescriptor_QueueType type, xdc_Ptr pNumDroppedCtr );
...
xdc__CODESECT(ti_uia_runtime_QueueDescriptor_removeFromList__F, "ti_uia_runtime_QueueDescriptor_removeFromList")
__extern xdc_Void ti_uia_runtime_QueueDescriptor_removeFromList__F( ti_uia_runtime_QueueDescriptor_Header* pHdrToRemove );
__extern xdc_Void ti_uia_runtime_QueueDescriptor_removeFromList__R( ti_uia_runtime_QueueDescriptor_Header* pHdrToRemove );
