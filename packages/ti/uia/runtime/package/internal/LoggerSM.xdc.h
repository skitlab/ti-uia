...
#define ti_uia_runtime_LoggerSM_setPartitionId ti_uia_runtime_LoggerSM_setPartitionId__F
...
#define ti_uia_runtime_LoggerSM_Module_startup ti_uia_runtime_LoggerSM_Module_startup__F

/* Instance_init */
#undef ti_uia_runtime_LoggerSM_Instance_init
#define ti_uia_runtime_LoggerSM_Instance_init ti_uia_runtime_LoggerSM_Instance_init__F

/* Instance_finalize */
#undef ti_uia_runtime_LoggerSM_Instance_finalize
#define ti_uia_runtime_LoggerSM_Instance_finalize ti_uia_runtime_LoggerSM_Instance_finalize__F
