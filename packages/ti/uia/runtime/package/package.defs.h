...
/*
 * ======== module ti.uia.runtime.LoggerCircBuf ========
 */

typedef struct ti_uia_runtime_LoggerCircBuf_Module_State ti_uia_runtime_LoggerCircBuf_Module_State;
typedef struct ti_uia_runtime_LoggerCircBuf_Fxns__ ti_uia_runtime_LoggerCircBuf_Fxns__;
typedef const ti_uia_runtime_LoggerCircBuf_Fxns__* ti_uia_runtime_LoggerCircBuf_Module;
typedef struct ti_uia_runtime_LoggerCircBuf_Params ti_uia_runtime_LoggerCircBuf_Params;
typedef struct ti_uia_runtime_LoggerCircBuf_Object ti_uia_runtime_LoggerCircBuf_Object;
typedef struct ti_uia_runtime_LoggerCircBuf_Struct ti_uia_runtime_LoggerCircBuf_Struct;
typedef ti_uia_runtime_LoggerCircBuf_Object* ti_uia_runtime_LoggerCircBuf_Handle;
typedef struct ti_uia_runtime_LoggerCircBuf_Object__ ti_uia_runtime_LoggerCircBuf_Instance_State;
typedef ti_uia_runtime_LoggerCircBuf_Object* ti_uia_runtime_LoggerCircBuf_Instance;

/*
 * ======== module ti.uia.runtime.LoggerProbePoint ========
 */

typedef struct ti_uia_runtime_LoggerProbePoint_Module_State ti_uia_runtime_LoggerProbePoint_Module_State;
typedef struct ti_uia_runtime_LoggerProbePoint_Fxns__ ti_uia_runtime_LoggerProbePoint_Fxns__;
typedef const ti_uia_runtime_LoggerProbePoint_Fxns__* ti_uia_runtime_LoggerProbePoint_Module;
typedef struct ti_uia_runtime_LoggerProbePoint_Params ti_uia_runtime_LoggerProbePoint_Params;
typedef struct ti_uia_runtime_LoggerProbePoint_Object ti_uia_runtime_LoggerProbePoint_Object;
typedef struct ti_uia_runtime_LoggerProbePoint_Struct ti_uia_runtime_LoggerProbePoint_Struct;
typedef ti_uia_runtime_LoggerProbePoint_Object* ti_uia_runtime_LoggerProbePoint_Handle;
typedef struct ti_uia_runtime_LoggerProbePoint_Object__ ti_uia_runtime_LoggerProbePoint_Instance_State;
typedef ti_uia_runtime_LoggerProbePoint_Object* ti_uia_runtime_LoggerProbePoint_Instance;

/*
 * ======== module ti.uia.runtime.LoggerStopMode ========
 */

typedef struct ti_uia_runtime_LoggerStopMode_Module_State ti_uia_runtime_LoggerStopMode_Module_State;
typedef struct ti_uia_runtime_LoggerStopMode_Fxns__ ti_uia_runtime_LoggerStopMode_Fxns__;
typedef const ti_uia_runtime_LoggerStopMode_Fxns__* ti_uia_runtime_LoggerStopMode_Module;
typedef struct ti_uia_runtime_LoggerStopMode_Params ti_uia_runtime_LoggerStopMode_Params;
typedef struct ti_uia_runtime_LoggerStopMode_Object ti_uia_runtime_LoggerStopMode_Object;
typedef struct ti_uia_runtime_LoggerStopMode_Struct ti_uia_runtime_LoggerStopMode_Struct;
typedef ti_uia_runtime_LoggerStopMode_Object* ti_uia_runtime_LoggerStopMode_Handle;
typedef struct ti_uia_runtime_LoggerStopMode_Object__ ti_uia_runtime_LoggerStopMode_Instance_State;
typedef ti_uia_runtime_LoggerStopMode_Object* ti_uia_runtime_LoggerStopMode_Instance;
