...
#define ti_uia_runtime_ServiceMgr_SupportProxy___VERS 150
...
/* Handle__label__S */
xdc__CODESECT(ti_uia_runtime_ServiceMgr_SupportProxy_Handle__label__S, "ti_uia_runtime_ServiceMgr_SupportProxy_Handle__label")
...
xdc__CODESECT(ti_uia_runtime_ServiceMgr_SupportProxy_Module__startupDone__S, "ti_uia_runtime_ServiceMgr_SupportProxy_Module__startupDone")
__extern xdc_Bool ti_uia_runtime_ServiceMgr_SupportProxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_uia_runtime_ServiceMgr_SupportProxy_Object__create__S, "ti_uia_runtime_ServiceMgr_SupportProxy_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_uia_runtime_ServiceMgr_SupportProxy_Object__delete__S, "ti_uia_runtime_ServiceMgr_SupportProxy_Object__delete")
__extern xdc_Void ti_uia_runtime_ServiceMgr_SupportProxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_uia_runtime_ServiceMgr_SupportProxy_Object__destruct__S, "ti_uia_runtime_ServiceMgr_SupportProxy_Object__destruct")
__extern xdc_Void ti_uia_runtime_ServiceMgr_SupportProxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_uia_runtime_ServiceMgr_SupportProxy_Object__get__S, "ti_uia_runtime_ServiceMgr_SupportProxy_Object__get")
__extern xdc_Ptr ti_uia_runtime_ServiceMgr_SupportProxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_uia_runtime_ServiceMgr_SupportProxy_Object__first__S, "ti_uia_runtime_ServiceMgr_SupportProxy_Object__first")
__extern xdc_Ptr ti_uia_runtime_ServiceMgr_SupportProxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_uia_runtime_ServiceMgr_SupportProxy_Object__next__S, "ti_uia_runtime_ServiceMgr_SupportProxy_Object__next")
__extern xdc_Ptr ti_uia_runtime_ServiceMgr_SupportProxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_uia_runtime_ServiceMgr_SupportProxy_Params__init__S, "ti_uia_runtime_ServiceMgr_SupportProxy_Params__init")
__extern xdc_Void ti_uia_runtime_ServiceMgr_SupportProxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(ti_uia_runtime_ServiceMgr_SupportProxy_Proxy__abstract__S, "ti_uia_runtime_ServiceMgr_SupportProxy_Proxy__abstract")
__extern xdc_Bool ti_uia_runtime_ServiceMgr_SupportProxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(ti_uia_runtime_ServiceMgr_SupportProxy_Proxy__delegate__S, "ti_uia_runtime_ServiceMgr_SupportProxy_Proxy__delegate")
...
xdc__CODESECT(ti_uia_runtime_ServiceMgr_SupportProxy_freePacket__R, "ti_uia_runtime_ServiceMgr_SupportProxy_freePacket")
__extern xdc_Void ti_uia_runtime_ServiceMgr_SupportProxy_freePacket__R( ti_uia_runtime_UIAPacket_Hdr* packet );
...
xdc__CODESECT(ti_uia_runtime_ServiceMgr_SupportProxy_getFreePacket__R, "ti_uia_runtime_ServiceMgr_SupportProxy_getFreePacket")
__extern ti_uia_runtime_UIAPacket_Hdr* ti_uia_runtime_ServiceMgr_SupportProxy_getFreePacket__R( ti_uia_runtime_UIAPacket_HdrType type, xdc_UInt timeout );
...
xdc__CODESECT(ti_uia_runtime_ServiceMgr_SupportProxy_requestEnergy__R, "ti_uia_runtime_ServiceMgr_SupportProxy_requestEnergy")
__extern xdc_Void ti_uia_runtime_ServiceMgr_SupportProxy_requestEnergy__R( xdc_Int id );
...
xdc__CODESECT(ti_uia_runtime_ServiceMgr_SupportProxy_sendPacket__R, "ti_uia_runtime_ServiceMgr_SupportProxy_sendPacket")
__extern xdc_Bool ti_uia_runtime_ServiceMgr_SupportProxy_sendPacket__R( ti_uia_runtime_UIAPacket_Hdr* packet );
...
xdc__CODESECT(ti_uia_runtime_ServiceMgr_SupportProxy_setPeriod__R, "ti_uia_runtime_ServiceMgr_SupportProxy_setPeriod")
__extern xdc_Void ti_uia_runtime_ServiceMgr_SupportProxy_setPeriod__R( xdc_Int id, xdc_UInt32 periodInMs );
