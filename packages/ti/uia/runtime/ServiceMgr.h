...
#define ti_uia_runtime_ServiceMgr___VERS 150
...
xdc__CODESECT(ti_uia_runtime_ServiceMgr_Module__startupDone__S, "ti_uia_runtime_ServiceMgr_Module__startupDone")
...
__extern xdc_Void ti_uia_runtime_ServiceMgr_freePacket__R( ti_uia_runtime_UIAPacket_Hdr* packet );
...
__extern ti_uia_runtime_UIAPacket_Hdr* ti_uia_runtime_ServiceMgr_getFreePacket__R( ti_uia_runtime_UIAPacket_HdrType type, xdc_UInt timeout );
...
__extern xdc_Int ti_uia_runtime_ServiceMgr_getNumServices__R( void );
...
__extern xdc_Void ti_uia_runtime_ServiceMgr_processCallback__R( ti_uia_runtime_ServiceMgr_ServiceId id, ti_uia_runtime_ServiceMgr_Reason reason, ti_uia_runtime_UIAPacket_Hdr* packet );
...
__extern xdc_Void ti_uia_runtime_ServiceMgr_requestEnergy__R( ti_uia_runtime_ServiceMgr_ServiceId id );
...
__extern xdc_Bool ti_uia_runtime_ServiceMgr_sendPacket__R( ti_uia_runtime_UIAPacket_Hdr* packet );
...
__extern xdc_Void ti_uia_runtime_ServiceMgr_setPeriod__R( ti_uia_runtime_ServiceMgr_ServiceId id, xdc_UInt32 periodInMs );
