...
#define ti_uia_runtime_ILoggerSnapshot___VERS 150
...
/* delete */
static inline void ti_uia_runtime_ILoggerSnapshot_delete( ti_uia_runtime_ILoggerSnapshot_Handle* instp )
{
...
/* enable_{FxnT,fxnP} */
typedef xdc_Bool (*ti_uia_runtime_ILoggerSnapshot_enable_FxnT)(void*);
...
/* disable_{FxnT,fxnP} */
typedef xdc_Bool (*ti_uia_runtime_ILoggerSnapshot_disable_FxnT)(void*);
...
/* write0_{FxnT,fxnP} */
typedef xdc_Void (*ti_uia_runtime_ILoggerSnapshot_write0_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId);
...
/* write1_{FxnT,fxnP} */
typedef xdc_Void (*ti_uia_runtime_ILoggerSnapshot_write1_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg);
...
/* write2_{FxnT,fxnP} */
typedef xdc_Void (*ti_uia_runtime_ILoggerSnapshot_write2_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg);
...
/* write4_{FxnT,fxnP} */
typedef xdc_Void (*ti_uia_runtime_ILoggerSnapshot_write4_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
...
/* write8_{FxnT,fxnP} */
typedef xdc_Void (*ti_uia_runtime_ILoggerSnapshot_write8_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
...
typedef xdc_Void (*ti_uia_runtime_ILoggerSnapshot_setFilterLevel_FxnT)(void*, xdc_runtime_Diags_Mask, xdc_runtime_Diags_EventLevel);
...
typedef xdc_runtime_Diags_Mask (*ti_uia_runtime_ILoggerSnapshot_getFilterLevel_FxnT)(void*, xdc_runtime_Diags_EventLevel);
...
typedef ti_uia_runtime_IUIATransfer_TransferType (*ti_uia_runtime_ILoggerSnapshot_getTransferType_FxnT)(void*);
...
typedef xdc_Bool (*ti_uia_runtime_ILoggerSnapshot_getContents_FxnT)(void*, xdc_Ptr, xdc_SizeT, xdc_SizeT*);
...
/* isEmpty_{FxnT,fxnP} */
typedef xdc_Bool (*ti_uia_runtime_ILoggerSnapshot_isEmpty_FxnT)(void*);
...
typedef xdc_SizeT (*ti_uia_runtime_ILoggerSnapshot_getMaxLength_FxnT)(void*);
...
typedef xdc_UInt16 (*ti_uia_runtime_ILoggerSnapshot_getInstanceId_FxnT)(void*);
...
typedef ti_uia_runtime_IUIATransfer_Priority (*ti_uia_runtime_ILoggerSnapshot_getPriority_FxnT)(void*);
...
typedef xdc_Void (*ti_uia_runtime_ILoggerSnapshot_setPriority_FxnT)(void*, ti_uia_runtime_IUIATransfer_Priority);
...
/* reset_{FxnT,fxnP} */
typedef xdc_Void (*ti_uia_runtime_ILoggerSnapshot_reset_FxnT)(void*);
...
typedef xdc_Void (*ti_uia_runtime_ILoggerSnapshot_writeMemoryRange_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_UInt32, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_UInt32);
