...
#define ti_uia_runtime_UIAMetaData___VERS 150
...
xdc__CODESECT(ti_uia_runtime_UIAMetaData_Module__startupDone__S, "ti_uia_runtime_UIAMetaData_Module__startupDone")
