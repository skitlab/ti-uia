...
#define ti_uia_runtime_MultiCoreTypes___VERS 150
...
xdc__CODESECT(ti_uia_runtime_MultiCoreTypes_Module__startupDone__S, "ti_uia_runtime_MultiCoreTypes_Module__startupDone")
