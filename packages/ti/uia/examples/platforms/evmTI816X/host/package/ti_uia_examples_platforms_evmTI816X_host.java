...
public class ti_uia_examples_platforms_evmTI816X_host
{
    ...
    void Platform$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.uia.examples.platforms.evmTI816X.host.Platform.Object", new Proto.Str(po, true));
    ...
    void Platform$$CREATES()
    {
        ...
        sb.append("ti$uia$examples$platforms$evmTI816X$host$Platform$$create = function( name, args, __params ) {\n");
        ...
        fxn = (Proto.Fxn)om.bind("ti.uia.examples.platforms.evmTI816X.host.Platform$$construct", new Proto.Fxn(om.findStrict("ti.uia.examples.platforms.evmTI816X.host.Platform.Module", "ti.uia.examples.platforms.evmTI816X.host"), null, 4, 2, false));
                ...
                fxn.addArg(3, "__params", (Proto)om.findStrict("ti.uia.examples.platforms.evmTI816X.host.Platform.Params", "ti.uia.examples.platforms.evmTI816X.host"), Global.newObject());
        sb = new StringBuilder();
        sb.append("ti$uia$examples$platforms$evmTI816X$host$Platform$$construct = function( __obj, name, args, __params ) {\n");
            sb.append("var __mod = xdc.om['ti.uia.examples.platforms.evmTI816X.host.Platform'];\n");
