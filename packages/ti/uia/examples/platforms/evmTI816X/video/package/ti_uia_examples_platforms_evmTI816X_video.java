...
public class ti_uia_examples_platforms_evmTI816X_video
{
    ...
    void Platform$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.uia.examples.platforms.evmTI816X.video.Platform.Object", new Proto.Str(po, true));
    ...
    void Platform$$CREATES()
    {
        ...
        sb.append("ti$uia$examples$platforms$evmTI816X$video$Platform$$create = function( name, args, __params ) {\n");
        ...
        fxn = (Proto.Fxn)om.bind("ti.uia.examples.platforms.evmTI816X.video.Platform$$construct", new Proto.Fxn(om.findStrict("ti.uia.examples.platforms.evmTI816X.video.Platform.Module", "ti.uia.examples.platforms.evmTI816X.video"), null, 4, 2, false));
                ...
                fxn.addArg(3, "__params", (Proto)om.findStrict("ti.uia.examples.platforms.evmTI816X.video.Platform.Params", "ti.uia.examples.platforms.evmTI816X.video"), Global.newObject());
        sb = new StringBuilder();
        sb.append("ti$uia$examples$platforms$evmTI816X$video$Platform$$construct = function( __obj, name, args, __params ) {\n");
            sb.append("var __mod = xdc.om['ti.uia.examples.platforms.evmTI816X.video.Platform'];\n");
