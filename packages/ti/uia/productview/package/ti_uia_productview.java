...
public class ti_uia_productview
{
    ...
    void UiaProductView$$TYPES()
    {
        ...
        po.addFld("ti_uia_runtime_LoggerCircBuf", (Proto)om.findStrict("ti.uia.productview.UiaProductView.ProductElemDesc", "ti.uia.productview"), $$DEFAULT, "wh");
        po.addFld("ti_uia_runtime_LoggerProbePoint", (Proto)om.findStrict("ti.uia.productview.UiaProductView.ProductElemDesc", "ti.uia.productview"), $$DEFAULT, "wh");
        po.addFld("ti_uia_runtime_LoggerStopMode", (Proto)om.findStrict("ti.uia.productview.UiaProductView.ProductElemDesc", "ti.uia.productview"), $$DEFAULT, "wh");
