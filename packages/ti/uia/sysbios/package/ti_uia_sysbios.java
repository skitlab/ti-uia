...
public class ti_uia_sysbios
{
    ...
    void LoggerStreamer$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.uia.sysbios.LoggerStreamer.Object", new Proto.Str(po, false));
    ...
    void LoggerIdle$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.uia.sysbios.LoggerIdle.Object", new Proto.Str(po, false));
    ...
    void LoggerIdle$$SIZES()
    {
        ...
        sizes.add(Global.newArray("idleSequence", "UInt"));
    ...
    void LoggingSetup$$TYPES()
    {
        ...
        po.addFld("disableMulticoreEventCorrelation", $$T_Bool, false, "wh");
        fxn = Global.get(cap, "module$use");
    ...
    void LoggerIdle$$TYPES()
    {
        ...
        po.init("ti.uia.sysbios.LoggerIdle.Module_State", null);
                ...
                po.addFld("idleSequence", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/release/ti.uia.sysbios.a64P',\n");
            sb.append("'lib/release/ti.uia.sysbios.a64Pe',\n");
            sb.append("'lib/release/ti.uia.sysbios.a674',\n");
            sb.append("'lib/release/ti.uia.sysbios.ae64P',\n");
            sb.append("'lib/release/ti.uia.sysbios.ae66',\n");
            sb.append("'lib/release/ti.uia.sysbios.ae66e',\n");
            sb.append("'lib/release/ti.uia.sysbios.ae64Pe',\n");
            sb.append("'lib/release/ti.uia.sysbios.ae674',\n");
            sb.append("'lib/release/ti.uia.sysbios.ae64T',\n");
            ...
            sb.append("'lib/release/ti.uia.sysbios.aea8f',\n");
            sb.append("'lib/release/ti.uia.sysbios.aea8fnv',\n");
            sb.append("'lib/release/ti.uia.sysbios.a28FP',\n");
            sb.append("'lib/release/ti.uia.sysbios.ae430X',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/release/ti.uia.sysbios.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/release/ti.uia.sysbios.a64Pe', {target: 'ti.targets.C64P_big_endian', suffix: '64Pe'}],\n");
            sb.append("['lib/release/ti.uia.sysbios.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/release/ti.uia.sysbios.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/release/ti.uia.sysbios.ae66', {target: 'ti.targets.elf.C66', suffix: 'e66'}],\n");
            sb.append("['lib/release/ti.uia.sysbios.ae66e', {target: 'ti.targets.elf.C66_big_endian', suffix: 'e66e'}],\n");
            sb.append("['lib/release/ti.uia.sysbios.ae64Pe', {target: 'ti.targets.elf.C64P_big_endian', suffix: 'e64Pe'}],\n");
            sb.append("['lib/release/ti.uia.sysbios.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/release/ti.uia.sysbios.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
            ...
            sb.append("['lib/release/ti.uia.sysbios.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
            sb.append("['lib/release/ti.uia.sysbios.aea8fnv', {target: 'ti.targets.arm.elf.A8Fnv', suffix: 'ea8fnv'}],\n");
            sb.append("['lib/release/ti.uia.sysbios.a28FP', {target: 'ti.targets.C28_float', suffix: '28FP'}],\n");
            sb.append("['lib/release/ti.uia.sysbios.ae430X', {target: 'ti.targets.msp430.elf.MSP430X', suffix: 'e430X'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
    ...
    void LoggerStreamer$$SINGLETONS()
    {
        ...
        loggables.add(Global.newObject("name", "prime", "entry", "%p", "exit", "%d"));
        vo.bind("$$loggables", loggables.toArray());
    ...
    void LoggerIdle$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_uia_sysbios_LoggerIdle_Handle__label__E", "ti_uia_sysbios_LoggerIdle_Module__startupDone__E", "ti_uia_sysbios_LoggerIdle_Object__create__E", "ti_uia_sysbios_LoggerIdle_Object__delete__E", "ti_uia_sysbios_LoggerIdle_Object__destruct__E", "ti_uia_sysbios_LoggerIdle_Object__get__E", "ti_uia_sysbios_LoggerIdle_Object__first__E", "ti_uia_sysbios_LoggerIdle_Object__next__E", "ti_uia_sysbios_LoggerIdle_Params__init__E", "ti_uia_sysbios_LoggerIdle_enable__E", "ti_uia_sysbios_LoggerIdle_disable__E", "ti_uia_sysbios_LoggerIdle_write0__E", "ti_uia_sysbios_LoggerIdle_write1__E", "ti_uia_sysbios_LoggerIdle_write2__E", "ti_uia_sysbios_LoggerIdle_write4__E", "ti_uia_sysbios_LoggerIdle_write8__E"));
        vo.bind("$$logEvtCfgs", Global.newArray("L_test"));
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
