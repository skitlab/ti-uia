...
#define ti_uia_sysbios_LoggerIdle_enable ti_uia_sysbios_LoggerIdle_enable__F

/* disable */
#undef ti_uia_sysbios_LoggerIdle_disable
#define ti_uia_sysbios_LoggerIdle_disable ti_uia_sysbios_LoggerIdle_disable__F
...
#define ti_uia_sysbios_LoggerIdle_Module_startup ti_uia_sysbios_LoggerIdle_Module_startup__F

/* Instance_init */
#undef ti_uia_sysbios_LoggerIdle_Instance_init
#define ti_uia_sysbios_LoggerIdle_Instance_init ti_uia_sysbios_LoggerIdle_Instance_init__F

/* Instance_finalize */
#undef ti_uia_sysbios_LoggerIdle_Instance_finalize
#define ti_uia_sysbios_LoggerIdle_Instance_finalize ti_uia_sysbios_LoggerIdle_Instance_finalize__F
